...
class QQuickBgfxItem : public QQuickItem
{
    ...
    Q_PROPERTY(QString rectName READ rectName WRITE setRectName NOTIFY rectNameChanged)
...
public:
    ...
    QString rectName() const { return m_rectName; }
    void setRectName(QString name);
